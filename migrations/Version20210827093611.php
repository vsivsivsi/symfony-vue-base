 ...
 */
final class Version20210827093611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ALTER COLUMN price INT');
//        $this->addSql('ALTER TABLE product DROP CONSTRAINT DF_D34A04AD_D0354274');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ALTER COLUMN price DOUBLE PRECISION');
        $this->addSql('ALTER TABLE product ALTER COLUMN stock_quantity INT NOT NULL');
